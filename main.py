...
# ======================================================
    ...
    def build(self):
        ...
        self.CONFIG_FILE = Path(self.user_data_dir)/"smtp_config.json"
        self.EXPORT_FILE = Path(self.user_data_dir)/"export_folder.json"
...
# ======================================================
    ...
    def load_full_excel(self,_):
        ...
        self.full_data=[[ "" if v is None else str(v) for v in r ] for r in sheet.iter_rows(values_only=True)]
...
# ======================================================
    ...
    def _on_folder_result(self,request_code,result_code,intent):
        ...
        self._popup("Folder zapisany",path)
    ...
    def _export_thread(self):
        ...
        for i,row in enumerate(rows):
            ...
            for c in range(1,len(header)+1):
                ...
                d=ws.cell(row=2,column=c)
                d.alignment=Alignment(horizontal="center")
                d.border=border

            name=row[1] if len(row)>1 else "rekord"
            ...
            Clock.schedule_once(lambda dt,v=i: setattr(self.progress,"value",(v+1)/total*100))
