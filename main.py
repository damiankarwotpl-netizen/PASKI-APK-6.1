...
class FutureApp(App):
    def build(self):
        ...
        self.global_attachments = []; self.selected_emails = []
    ...
    def setup_ui(self):
        ...
        # Naprawa Emoji - zastąpienie ikon tekstowymi odpowiednikami lub usuwanie
    ...
    def setup_tmpl(self):
        ...
        l.add_widget(Label(text="TREŚĆ WIADOMOŚCI", bold=True)); l.add_widget(self.ti_ts); l.add_widget(self.ti_tb); l.add_widget(PremiumButton(text="ZAPISZ", on_press=sv_tmpl)); l.add_widget(PremiumButton(text="POWRÓT", on_press=lambda x: setattr(self.sm, 'current', 'email'), background_color=(0.4,0.4,0.4,1))); self.pages["tmpl"].add_widget(l)
