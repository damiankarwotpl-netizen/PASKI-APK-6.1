...
# =========================================================
# FUTURE APP FULL PATCH (MAIL ENGINE + MOBILE UI)
# =========================================================
...
def patched_load_email_excel(self,path):
    ...
    self.popup("Email",f"Wczytano {len(self.email_map)} adresów")
