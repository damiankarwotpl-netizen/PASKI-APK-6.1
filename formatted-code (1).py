...
def import_address_book(self, _):
        ...
        for row in self.filtered_data:
            ...
            for cell in row:
                ...
                self.grid.add_widget(
                    Label(text=str(cell), size_hint=(None, None), size=(w, h))
                )
    ...
    def _email_thread(self):
        ...
        Clock.schedule_once(lambda dt: self.popup("Gotowe", f"Wysłano {sent} emaili"))
...
def mail_thread(self):
    ...
    if not smtp:
        ...
        Clock.schedule_once(lambda dt: self.popup("SMTP", "Brak konfiguracji"))
    ...
    try:
        ...
        Clock.schedule_once(lambda dt: self.popup("SMTP", str(e)))
    ...
    Clock.schedule_once(lambda dt: self.popup("Email", f"Wysłano {sent} wiadomości"))
